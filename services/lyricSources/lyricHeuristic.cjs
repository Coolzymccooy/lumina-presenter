// Plain-JS sibling of lyricHeuristic.ts for Electron main-process consumption.
// Electron's Node ESM loader cannot resolve `.ts` files, so the watcher imports this file.
// Keep behavior in sync with lyricHeuristic.ts.
...
module.exports = { looksLikeLyrics };
